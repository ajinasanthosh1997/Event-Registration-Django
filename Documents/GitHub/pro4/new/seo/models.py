...
class PageSEO(models.Model):
    url_path = models.CharField(max_length=255, unique=True, help_text="URL path without domain (e.g., '/about/')")
    title = models.CharField(max_length=100, help_text="Page title (100 characters)")
    meta_description = models.TextField(max_length=160, help_text="Meta description (150-160 characters)")
    ...
    image_alt = models.CharField(max_length=255, blank=True, help_text="ALT text for main image")
    ...
    og_title = models.CharField(
        max_length=100,
        blank=True,
        help_text="Open Graph title (if empty, uses title field)"
    )
